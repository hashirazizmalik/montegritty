...
const VOICE_MENU = [
  'helpdesk-agent (female, patient, general support)',
  'broadband-support (male, polished, technical support)',
  'shopkeeper (male, warm, retail and orders)',
  'sindhi-professional (female, composed, finance and admin)',
  'punjabi-manager (male, steady, sales and property)',
  'montessori-teacher (female, warm but firm, schools)',
  'paediatrician (female, reassuring, healthcare)',
  'diabetologist (male, educational, clinical follow-up)',
  'punjabi-masi (female, warm rural register, outreach)',
  'dha-hostess (female, polished, hospitality)',
  'news-anchor (female, sharp, announcements)',
  'lahori-story-uncle (male, deep and warm, storytelling)',
].join('\n');
...
Once you have enough, say you are building it now, then call the create_agent tool. Choose the voice yourself from this list based on what they described:
${VOICE_MENU}
    ...
    builderPromise = call('/realtime-assistants', {
      body: {
        ...
        config: {
          ...
          ...STACK,
          tts: {
            default: { provider: 'upliftai', voiceId: 'helpdesk-agent', outputFormat: 'MP3_22050_128' },
          },
        },
      },
    })
