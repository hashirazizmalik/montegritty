...
export const CONTACT = {
  whatsappDisplay: "0305 5684317",
  // wa.me requires full international format, no plus, no spaces (92 = Pakistan)
  whatsappLink: "https://wa.me/923055684317",
  email: "hello@montegritty.com",
 ...
 *
 * These quotes were written as placeholder copy. They are attributed to real,
 * named people at real companies. Get written sign-off from each person before
 * this goes to production, and replace any quote they'd like worded differently.
 */
export const TESTIMONIALS = [
  ...
  {
    company: "Makka Groups",
    name: "Atif Shehzad",
    role: "Chief Executive Officer",
    initials: "AS",
    quote:
      "Our operation spans several business units that had never shared a system. Montegritty mapped all of it before writing a line of code, then delivered in phases so nothing stopped running while we moved. The rollout was the least disruptive technology change we've been through.",
  },
  {
