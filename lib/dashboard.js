...
export const DASH_HOURLY = [
  38, 21, 14, 9, 7, 12, 34, 88, 162, 244, 291, 268,
  212, 236, 279, 318, 342, 397, 441, 386, 297, 198, 121, 63,
];

export const DASH_HOURLY_NOTE =
  'سب سے زیادہ رَش شام 6 سے 7 بجے — 441 کالز۔ اسی ایک گھنٹے میں 34 انسانی ایجنٹس درکار ہوتے۔';
