...
export const CONTACT = {
  ...
  // The enquiry form appends ?text=... per submission; this is the bare base link.
...
export const VERTICALS = [
  ...
  },
  {
    ...
    body: "Turn traffic into revenue with storefronts, CRM pipelines, and paid campaigns engineered to convert — built for brands that live and die by conversion rate.",
    tags: ["UI/UX", "Meta Ads"],
  },
  {
    idx: "06",
    title: "Technology & SaaS",
    body: "Ship product faster and automate the operational load that slows every growing tech company down — from onboarding and support to internal tooling.",
