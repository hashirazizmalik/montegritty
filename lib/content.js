...
export const CONTACT = {
  ...
  email: "montegritty@gmail.com",
  emailLink: "mailto:montegritty@gmail.com",
...
export const SOCIAL = [
  { href: "https://www.linkedin.com/company/montegritty/", label: "LinkedIn" },
  { href: "https://www.instagram.com/montegritty", label: "Instagram" },
];
...
export const FOOTER = {
  ...
  about: { href: "/about", label: "About Montegritty" },
  columns: [
    {
      title: "Who it's for",
      links: [
...
/**
 * ABOUT_PAGE — the entity page. Every fact here must be independently true and
 * checkable elsewhere on the site or in CONTACT; do not add a founding date,
 * an address, a team size or a client count unless it is real. An unverifiable
 * claim on this specific page is worse than a short page, because this is the
 * page search and AI engines read to decide whether the company is real.
 */
export const ABOUT_PAGE = {
  eyebrow: "About",
  heading: ["Pakistan's first Urdu-first ", "agentic", " voice agents"],
  lede:
    "Montegritty builds voice agents that speak Urdu and act on it — reading a schedule, booking a slot, confirming an order and writing the outcome into the system you already run, before the caller hangs up.",
  pillars: [
    {
      title: "It acts, not just talks",
      body: "Every call ends with a record changed in your systems, not a transcript for someone to action later.",
    },
    {
      title: "Not welded to one vendor",
      body: "Uplift AI for Urdu, ElevenLabs for English, Vapi for telephony, self-hosted open-source where data cannot leave. Chosen per project.",
    },
    {
      title: "We build it and run it",
      body: "Wired into your booking system, records or order feed, and accountable for one number agreed before anything is built.",
    },
  ],
  notEyebrow: "What we don't do",
  not: [
    "ERP rollouts",
    "CRM implementations",
    "Website builds",
  ...
  notNote:
    "We build and run voice agents. That is the whole business.",
  based: "Pakistan-based, remote-first.",
  close: "Hear what an agent actually sounds like",
};
