...
export const TEMPLATES = [
  ...
  T({
    ...
    category: 'support', voice: 'nazimabad-boy',
  ...
  T({
    ...
    category: 'commerce', voice: 'college-girl',
  ...
  T({
    ...
    category: 'commerce', voice: 'punjabi-masi',
  ...
  T({
    ...
    category: 'commerce', voice: 'traffic-cop',
  ...
  T({
    ...
    category: 'healthcare', voice: 'news-reader',
  ...
  T({
    ...
    category: 'healthcare', voice: 'montessori-teacher',
  ...
  T({
    ...
    category: 'finance', voice: 'navy-officer',
  ...
  T({
    ...
    category: 'finance', voice: 'dha-hostess',
  ...
  T({
    ...
    category: 'property', voice: 'karachi-romeo',
  ...
  T({
    ...
    category: 'property', voice: 'dha-matriarch',
  ...
  T({
    ...
    category: 'education', voice: 'headmaster',
  ...
  T({
    ...
    category: 'education', voice: 'dha-matriarch',
  ...
  T({
    ...
    category: 'government', voice: 'punjabi-masi', demo: 'zainab-outreach',
  ...
  T({
    ...
    category: 'government', voice: 'balochi-seamstress',
  ...
  T({
    ...
    category: 'government', voice: 'traffic-cop',
  ...
  T({
    ...
    category: 'logistics', voice: 'bus-conductor',
  ...
  T({
    ...
    category: 'hospitality', voice: 'biryani-reviewer',
  ...
  T({
    ...
    category: 'hospitality', voice: 'dha-teen-girl',
  ...
  T({
    id: 'radio-jockey', name: 'Late Night RJ', urName: 'نائٹ شو آر جے',
    category: 'media', voice: 'late-night-rj', languages: ['ur'],
    blurb: 'Hosts the segment, reads the dedications, keeps the tone warm.',
    greeting: 'السلام علیکم، رات کے اس پہر آپ کے ساتھ۔',
    instructions:
      'You host a late-night radio segment. Keep the tone intimate and unhurried. Read listener dedications and messages as written, skipping anything abusive, defamatory or that names a private individual without consent. Between segments, keep links short. Never give personal advice on air about medical, legal or financial matters.',
  }),
  T({
    id: 'match-commentary', name: 'Cricket Commentator', urName: 'کرکٹ کمنٹری',
    category: 'media', voice: 'cricket-commentator', languages: ['ur'],
  ...
  T({
    ...
    category: 'personal', voice: 'lahori-story-uncle', languages: ['ur'],
  ...
  T({
    ...
    category: 'personal', voice: 'mohalla-patriarch',
  ...
  T({
    ...
    category: 'personal', voice: 'qissa-khawan', languages: ['ur'],
  ...
  T({
    ...
    category: 'personal', voice: 'female-debater',
  ...
  T({
    ...
    category: 'personal', voice: 'orangi-khala',
