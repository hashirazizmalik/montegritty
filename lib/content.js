...
export const HERO = {
  eyebrow: "Voice AI for Pakistan",
  lines: ["Build a voice agent", "by talking"],
  lastLine: "to ",
  lastLineEm: "one.",
  lede:
    "Describe the call you want handled — out loud, in Urdu or English — and the studio builds a working agent while you speak. Or start from 52 ready-made templates and deploy one in seconds. Both give you a link you can send to anyone.",
  primary: { href: "/studio", label: "Build one by talking" },
  secondary: { href: "/templates", label: "Browse the templates" },
  statBig: "52",
  statLabel: "templates ready to deploy",
};
  ...
  columns: [
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/login", label: "Client & admin login" },
      ],
    },
  ],
};
